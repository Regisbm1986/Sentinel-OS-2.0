...
from sentinel_os.platform.backend.core.config import MODULES_DIR, PROJECT_ROOT, PYTHON_BIN
    ...
    for module_dir in sorted(modules_root.iterdir()):
        ...
        discovered.append(
            ModuleDefinition(
                ...
                mode=mode,
                fields=fields,
                module_path=f"sentinel_os.platform.backend.modules.{module_dir.name}.module",
