...
from sentinel_platform.backend.modules.beef.module import run_beef_daemon
from sentinel_platform.backend.modules.dagda.module import check_dagda_status, run_dagda
from sentinel_platform.backend.modules.enum4linux.module import run_enum4linux
from sentinel_platform.backend.modules.john.module import run_john_the_ripper
from sentinel_platform.backend.modules.kubehunter.module import run_kube_hunter
from sentinel_platform.backend.modules.nikto.module import run_nikto_api
from sentinel_platform.backend.modules.setoolkit.module import run_setoolkit_daemon
from sentinel_platform.backend.modules.spiderfoot.module import run_spiderfoot

from sentinel_platform.backend.platform.module_discovery import (
    ModuleDefinition,
    build_module_task,
    discover_modules,
