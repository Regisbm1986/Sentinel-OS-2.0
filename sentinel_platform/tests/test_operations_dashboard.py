...
from sentinel_platform.backend.dashboard.operations_dashboard import (
...
def test_dashboard_loaders_return_expected_sections(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("sentinel_platform.backend.dashboard.operations_dashboard.PROJECT_ROOT", project_root)
