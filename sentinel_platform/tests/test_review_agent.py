...
def test_review_generated_files_missing_router(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("sentinel_platform.backend.agents.review_agent.API_ROUTES_DIR", routes_dir)
...
def test_review_routes_missing_schema(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("sentinel_platform.backend.agents.review_agent.API_ROUTES_DIR", routes_dir)
    monkeypatch.setattr("sentinel_platform.backend.agents.review_agent.API_SCHEMAS_DIR", schemas_dir)
...
def test_review_generated_tasks_detects_missing_fields(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("sentinel_platform.backend.agents.review_agent.AGENT_TASKS_DIR", tasks_dir)
...
def test_review_telemetry_detects_non_completed(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("sentinel_platform.backend.agents.review_agent.PROJECT_ROOT", tmp_path)
