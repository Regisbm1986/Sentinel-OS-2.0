...
from sentinel_os.platform.backend.agents.queue_retry_manager import QueueRetryManager
...
def temp_queue(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("sentinel_os.platform.backend.agents.task_queue.AGENT_TASKS_DIR", queue_dir)
